...
/*   Updated: 2021/09/19 20:48:42 by jaekjung         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void _solve(int **map, int ***matrix, t_data input, t_point pnt, int cnt);
...
int main(int argc, char **argv)
{
	...
	*/
	_solve(map, matrix, input, _create_pnt(0, 0, 0, -1), 0);
	/*
	printf("Map\n");
	_print_map(map, n);
	printf("Matrix\n");
